  ...
  return (
    ...
    >
      <input
        ...
        type="text"
        className="w-full bg-blue-600/0 text-white px-6 py-2 border-none outline-none placeholder-slate-100 rounded-l-lg backdrop-blur-md"
        placeholder="City Name"
      />
      <button 
        type="submit" 
        className="bg-blue-600/0 p-2 rounded-r-lg hover:bg-blue-700 transition-colors duration-300 backdrop-blur-md"
      >
        <CiSearch 
