  ...
  fetchingData: async () => {
    ...
    try {
      ...
      if (timeOfDay === 'day') {
        ...
        } else if (contion === 1003 || contion === 1006 || contion === 1009 || contion === 1030 || contion === 1069 || contion === 1087 || contion === 1135 || contion === 1273 || contion === 1276 || contion === 1279 || contion === 1287) {
          getState().bgBlack = false
          getState().urlImg = cloudyDay

        } else if (contion === 1063 || contion === 1069 || contion === 1072 || contion === 1150 || contion === 1180 || contion === 1183 || contion === 1189 || contion === 1198 || contion === 1192 || contion === 1195 || contion === 1204 || contion === 1207 || contion === 1240 || contion === 1243 || contion === 1246 || contion === 1249 || contion === 1252) {
          getState().bgBlack = false
      ...
      set({ weatherInfo: info, hoursForecast: hoursData, currentHour: info.date.slice(11, 13), daysData });
